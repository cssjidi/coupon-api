	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			$data['menus'][] = array(
				'id'       => 'menu-taobao',
				'icon'	   => 'fa-dashboard',
				'name'	   => $this->language->get('text_taobao'),
			...
			if ($this->user->hasPermission('access', 'catalog/taobao')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_tb_product'),
					'href'     => $this->url->link('catalog/taobao', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			if ($this->user->hasPermission('access', 'catalog/union')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_all_product'),
					'href'     => $this->url->link('catalog/union', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
